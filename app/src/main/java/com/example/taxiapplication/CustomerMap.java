...
public class CustomerMap extends FragmentActivity implements OnMapReadyCallback{
    ...
    DatabaseReference nearesstDriverLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mMap.addMarker(new MarkerOptions().position(picupLacation).icon(BitmapDescriptorFactory.fromResource(R.drawable.passenger)).title("Pickup Here"));
    ...
    private void getNearestDriverLocation() {
        ...
        btn_request.setText("Getting your driver location...");

        nearesstDriverLocation = FirebaseDatabase
                .getInstance().getReference("DriversAvailable")
                .child(nearsDriverId).child("l");

        nearesstDriverLocation.addValueEventListener(new ValueEventListener() {
            @Override
